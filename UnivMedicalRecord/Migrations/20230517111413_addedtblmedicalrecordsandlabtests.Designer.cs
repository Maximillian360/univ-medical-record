...
namespace UnivMedicalRecord.Migrations
{
    ...
    [Migration("20230517111413_addedtblmedicalrecordsandlabtests")]
    partial class addedtblmedicalrecordsandlabtests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnivMedicalRecord.Models.Record.Allergy", b =>
                {
                    ...
                    b.Property<int>("GeneralRecordId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("GeneralRecordId");
            ...
            modelBuilder.Entity("UnivMedicalRecord.Models.Record.GeneralRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UnivMedicalRecord.Models.Record.Allergy", b =>
                {
                    b.HasOne("UnivMedicalRecord.Models.Record.GeneralRecord", "GeneralRecord")
                        .WithMany()
                        .HasForeignKey("GeneralRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeneralRecord");
                });
